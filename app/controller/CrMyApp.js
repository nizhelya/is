 ...
 * Date: Thu Mar 25 2021 21:34:15 GMT+0200 (EET)
 *
...
Ext.define('yis.controller.CrMyApp', {
    ...
    control: {
        ...
        "#grAppVodomerMtb": {
            selectionchange: 'onGrAppVodomerMtbSelectionChange'
        }
    },
    ...
    onListMenuMyFlatItemClick: function(dataview, record, item, index, e, eOpts) {
        ...
        if(StUser.data.length){
            ...
            var btnPrivatBank = Ext.getCmp("btnPrivatBank");
            ...
            callback: function(records,operation,success){
                ...
                if (success)  {
                    ...
                    if (records.length) {
                        ...
                        if (ipay !=="0"){
                            fsOsmd.setTitle("Внески на утримання будинку та прибудинкової території");
                            ...
                            fsOsmd.setTitle("у IPAY немає договору на прийом платежів по послуги " +
    ...
    onTabMarfinBankActivate: function(component, eOpts) {
        ...
        fmInfoApp.down('#insTekPokVodMtb').setDisabled(true);
        var fsOsmd = Ext.getCmp('fsOsmdMtb');
                ...
                if (success)  {
                    if (records.length) {
                        ...
                        if (mtb !=="0"){
                            ...
                            fsOsmd.setTitle("у МТБ банку немає договору на прийом платежів по послуги " +
                                            " 'Внески на утримання будинку та прибудинкової території'");
                            fmTekNachKassa.getForm().findField('cbNext5').setDisabled(true);
                        ...
                        fmTekNachKassa.down('#accountMtb').setDisabled(true);
    ...
    onGrAppVodomerMtbSelectionChange: function(model, selected, eOpts) {
        //in use
        //STORE
            ...
            stTekPokVodomera.load({
                ...
                callback: function(records,operation,success){
                    if(success){
                        ...
                        fmInfoApp.getForm().findField('place').setValue(records[0].get('place'));
                        fmInfoApp.getForm().findField('newValue').setDisabled(false);
                        fmInfoApp.down('#delTekPokVodMtb').setDisabled(false);
                        fmInfoApp.getForm().findField('newValue').setValue(0);
                        fmInfoApp.getForm().findField('newValue').focus();
