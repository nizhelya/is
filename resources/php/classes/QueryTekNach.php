			   ...
			   if($this->raion_id == 2 ||  $this->raion_id == 5 || $this->raion_id == 10){ 
				  $this->sql='SELECT CONCAT_WS(" ",t1.mec,t1.god) as period1, CONCAT_WS(" ",t2.mec,t2.god) as period2,'
						...
						$this->sql='SELECT CONCAT_WS(" ",t1.mec,t1.god) as period1, CONCAT_WS(" ",t2.mec,t2.god) as period2, CONCAT_WS(" ",t3.mec,t3.god) as period3,'
					      .'CONCAT_WS(" ",t4.mec,t4.god) as period4, CONCAT_WS(" ",t5.mec,t5.god) as period5, CONCAT_WS(" ",t6.mec,t6.god) as period6,CONCAT_WS(" ",t7.mec,t7.god) as period7,'
					      .'t1.zadol as zadol1,t2.zadol as zadol2,t3.zadol as zadol3,t4.zadol as zadol4,t5.zadol as zadol5,t5.fzadol as zadol8,t6.zadol as zadol6,t7.zadol as zadol7,'
					      .'(t1.zadol + t2.zadol + t3.zadol + t4.zadol + t5.zadol+ t5.fzadol + t6.zadol  + t7.zadol) as zadol ,'
					      .'t1.nachisleno as nachisleno1,t2.nachisleno as nachisleno2,t3.nachisleno as nachisleno3,t4.nachisleno as nachisleno4,'
					      .'t5.nachisleno as nachisleno5,t6.nachisleno as nachisleno6,t7.nachisleno as nachisleno7,'
					      .'t1.nachisleno + t2.nachisleno + t3.nachisleno + t4.nachisleno + t5.nachisleno + t6.nachisleno + t7.nachisleno as nachisleno,'
					      ...
					      .' t1.oplacheno+t2.oplacheno+t3.oplacheno+ t4.oplacheno+t5.oplacheno+t6.oplacheno +t7.oplacheno as oplacheno,'
					      ...
					      .' t1.subsidia+t2.subsidia+t3.subsidia+t4.subsidia+t5.subsidia+t6.subsidia +t7.subsidia as subsidia, '
					      .'t1.dolg as dolg1,t2.dolg as dolg2,t3.dolg as dolg3,t4.dolg as dolg4,t5.dolg as dolg5,t5.fdolg as dolg8,t5.ddolg as dolg9,t6.dolg as dolg6 ,t7.dolg as dolg7 ,'
					      .'t1.dolg +t2.dolg+t3.dolg +t4.dolg +t5.dolg+t5.fdolg+t6.dolg +t7.dolg as dolg ,'					      
					      .'(SELECT t10.`ipay`  FROM YISGRAND.OSMD as t10 WHERE  t10.`osmd_id` = t5.`osmd_id` ) as ipay,'
					      .'(SELECT t9.`mtb`  FROM YISGRAND.OSMD as t9 WHERE  t9.`osmd_id` = t5.`osmd_id` ) as mtb,'
					      .'(SELECT count(t8.`osmd_id`)  FROM YISGRAND.COMPANY_HOUSES as t8 WHERE  t8.`osmd_id` = t5.`osmd_id` AND t8.`org_id` in(3,6)) as rko '
					      .'FROM YIS.VODA as t1,YIS.STOKI as t2,YIS.KVARTPLATA as t5,YIS.TBO as t6 ,YIS.PODOGREV as t3,YIS.OTOPLENIE as t4,YIS.PTN as t7  '
					      ...
					      .' t5.address_id='.$this->address_id.'  AND t6.address_id='.$this->address_id.' AND t7.address_id='.$this->address_id.' AND '
					      .'t1.data=CONCAT(EXTRACT(YEAR_MONTH FROM curdate()),"01")  AND t2.data=CONCAT(EXTRACT(YEAR_MONTH FROM curdate()),"01") AND '
					      .'t3.data=CONCAT(EXTRACT(YEAR_MONTH FROM curdate()),"01")  AND t4.data=CONCAT(EXTRACT(YEAR_MONTH FROM curdate()),"01")  AND '
					      .'t5.data=CONCAT(EXTRACT(YEAR_MONTH FROM curdate()),"01")  AND t6.data=CONCAT(EXTRACT(YEAR_MONTH FROM curdate()),"01")  AND '					      .'t7.data=CONCAT(EXTRACT(YEAR_MONTH FROM curdate()),"01")';
				}
		//print($this->sql); 
...
break;
			   ...
			   if($this->raion_id == 2 ||  $this->raion_id == 5 || $this->raion_id == 10){ 
				...
				if ($this->house_id == 22  ) {
				  $this->sql='SELECT CONCAT_WS(" ",t1.mec,t1.god) as period1, CONCAT_WS(" ",t2.mec,t2.god) as period2, CONCAT_WS(" ",t3.mec,t3.god) as period3,'
					      ...
					      .'t1.dolg as dolg1,t2.dolg as dolg2,t3.dolg as dolg3,t8.dolg as dolg8,t4.dolg as dolg4,t5.dolg as dolg5,t6.dolg-t6.kdolg as dolg6 ,t7.dolg as dolg7 ,'
				...
				$this->sql='SELECT CONCAT_WS(" ",t1.mec,t1.god) as period1, CONCAT_WS(" ",t2.mec,t2.god) as period2, CONCAT_WS(" ",t3.mec,t3.god) as period3,'
					      ...
					      .' WHERE t1.address_id='.$this->address_id.'  AND t2.address_id='.$this->address_id.' AND t3.address_id='.$this->address_id.' '
					      .' AND t4.address_id='.$this->address_id.' AND t5.address_id='.$this->address_id.'  AND t6.address_id='.$this->address_id.' AND '
					      .' t7.address_id='.$this->address_id.' AND t1.data=CONCAT(EXTRACT(YEAR_MONTH FROM curdate()),"01")  AND '
					      .'t2.data=CONCAT(EXTRACT(YEAR_MONTH FROM curdate()),"01") AND t3.data=CONCAT(EXTRACT(YEAR_MONTH FROM curdate()),"01")  AND '
					      .'t4.data=CONCAT(EXTRACT(YEAR_MONTH FROM curdate()),"01")  AND t5.data=CONCAT(EXTRACT(YEAR_MONTH FROM curdate()),"01")  AND '
		    ...
		    break;
			   ...
			   if($this->raion_id == 2 ||  $this->raion_id == 5 || $this->raion_id == 10){ 
				  $this->sql='SELECT CONCAT_WS(" ",t1.mec,t1.god) as period1, CONCAT_WS(" ",t2.mec,t2.god) as period2,'
					      ...
					      .' t1.dolg +t2.dolg as dolg '					      
					      .'FROM YIS.VODA as t1,YIS.STOKI as t2'
					      .' WHERE t1.address_id='.$this->address_id.'  AND t2.address_id='.$this->address_id.'  AND '
				...
				$this->sql='SELECT CONCAT_WS(" ",t1.mec,t1.god) as period1, CONCAT_WS(" ",t2.mec,t2.god) as period2, CONCAT_WS(" ",t3.mec,t3.god) as period3,'
					      ...
					      .'FROM YIS.VODA as t1,YIS.STOKI as t2,YIS.KVARTPLATA as t3,YIS.TBO as t4,YIS.PODOGREV as t5,YIS.OTOPLENIE as t6 ,YIS.PTN as t7  '
					      .' WHERE t1.address_id='.$this->address_id.'  AND t2.address_id='.$this->address_id.' AND t3.address_id='.$this->address_id.' '
					      .' AND t4.address_id='.$this->address_id.' AND  t5.address_id='.$this->address_id.'  AND t6.address_id='.$this->address_id.' '
					      .' AND t7.address_id='.$this->address_id.' AND '
					      .'t1.data=CONCAT(EXTRACT(YEAR_MONTH FROM DATE_SUB(curdate(), INTERVAL 1 MONTH)),"01")  AND '
					      .'t2.data=CONCAT(EXTRACT(YEAR_MONTH FROM DATE_SUB(curdate(), INTERVAL 1 MONTH)),"01") AND '
					      .'t3.data=CONCAT(EXTRACT(YEAR_MONTH FROM DATE_SUB(curdate(), INTERVAL 1 MONTH)),"01")  AND '
					      .'t4.data=CONCAT(EXTRACT(YEAR_MONTH FROM DATE_SUB(curdate(), INTERVAL 1 MONTH)),"01")  AND '
		    ...
		    break;
				...
				$this->sql='SELECT CONCAT_WS(" ",t1.mec,t1.god) as period1, CONCAT_WS(" ",t2.mec,t2.god) as period2, CONCAT_WS(" ",t3.mec,t3.god) as period3,'
					      ...
					      .' WHERE t1.address_id='.$this->address_id.'  AND t2.address_id='.$this->address_id.' AND t3.address_id='.$this->address_id.'  '
					      .' AND t4.address_id='.$this->address_id.' AND t5.address_id='.$this->address_id.'  AND t6.address_id='.$this->address_id.' AND '
					      .' t7.address_id='.$this->address_id.' AND '
					      .'t1.data=CONCAT(EXTRACT(YEAR_MONTH FROM DATE_SUB(curdate(), INTERVAL 2 MONTH)),"01")  AND '
					      .'t2.data=CONCAT(EXTRACT(YEAR_MONTH FROM DATE_SUB(curdate(), INTERVAL 2 MONTH)),"01") AND '
					      .'t3.data=CONCAT(EXTRACT(YEAR_MONTH FROM DATE_SUB(curdate(), INTERVAL 2 MONTH)),"01")  AND '
					      .'t4.data=CONCAT(EXTRACT(YEAR_MONTH FROM DATE_SUB(curdate(), INTERVAL 2 MONTH)),"01")  AND '
		    ...
		    break;
			case "AppTekOplata":
			 $this->sql='SELECT rec_id,address_id,address, god, data,kvartplata,remont,ptn,otoplenie,podogrev,voda,stoki,tbo,summa,prixod,kassa,nomer,operator,data_in  FROM YIS.OPLATA  WHERE YIS.OPLATA.address_id='.$this->address_id.' ORDER BY YIS.OPLATA.rec_id DESC LIMIT 1';
			// print($this->sql);   
		    break;
		    case "AppTekOplataFive":
			 $this->sql='SELECT rec_id,address_id,address, god, data,kvartplata,remont,ptn,otoplenie,podogrev,voda,stoki,tbo,summa,prixod,kassa,nomer,operator,data_in  FROM YIS.OPLATA  WHERE YIS.OPLATA.address_id='.$this->address_id.' ORDER BY YIS.OPLATA.rec_id DESC LIMIT 5';
		    break;
			...
			break;
			case "PntAppAll":			
			      $this->sql='SELECT * FROM YIS.PTN WHERE `address_id` = '.$this->address_id.' ORDER BY YIS.PTN.`data` DESC' ;
			     // print_r($this->sql); 
			break;
			case "PodogrevAppAll":			
