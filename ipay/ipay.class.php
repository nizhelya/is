...
class iPay
{
	...
	function set_mode( $MODE ) {
		...
		switch( $MODE ) {
			...
			case 'test': $this->_SRVURL = 'http://localhost/ykis/ipay/ipay1.php'; break;
			#case 'real': $this->_SRVURL = 'https://api.ipay.ua/'; break;
			case 'real': $this->_SRVURL = 'http://localhost/ykis/ipay/ipay1.php'; break;
	...
	private function _build_create_array() {
		...
		$req['urls']['good'] = $this->_URL_G;		$req['urls']['bad']  = $this->_URL_B;		
